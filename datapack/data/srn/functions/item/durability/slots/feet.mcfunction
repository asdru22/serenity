...
data modify storage srn:storage root.temp.item set from entity @s Inventory[{Slot:100b}]

# Sets the item's data in storage
function srn:item/durability/modify/main
execute unless data storage srn:storage root.temp.item run item replace entity @s armor.feet with air
item modify entity @s armor.feet srn:durability_lore
data modify storage srn:storage root.temp.item set from entity @s Inventory[{Slot:100b}]
...
item modify entity @s armor.feet srn:copy_nbt
