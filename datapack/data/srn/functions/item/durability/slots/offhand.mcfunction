...
execute unless data storage srn:storage root.temp.item run item replace entity @s weapon.offhand with air
item modify entity @s weapon.offhand srn:durability_lore
data modify storage srn:storage root.temp.item set from entity @s Inventory[{Slot:-106b}]
...
item modify entity @s weapon.offhand srn:copy_nbt
